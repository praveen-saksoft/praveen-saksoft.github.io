  ...
  render() {
    return (h("div", { class: "aegon-age-widget", id: "aegon-age-widget" }, h("div", { class: "aegon-age-widget-picker" }, this.title &&
      ...
      h("ul", { class: "aegon-age-widget-monthslist" }, this.months.map((month, index) => h("li", { key: index, class: {
        ...
        } }, h("input", { class: "aegon-age-widget-monthinput", type: "radio", id: `month-${index}`, value: index, name: "possibleYear", onChange: e => this.selectMonth(e), disabled: this.getDisabledMonth(index + 1) }), h("label", { class: "aegon-age-widget-monthlabel", htmlFor: `month-${index}` }, month)))), this.showDate && this.daysInMonth &&
...
export { AegonAgeWidget as aegon_age_widget2 };
