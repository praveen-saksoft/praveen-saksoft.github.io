...
import { r as requestUserMedia, g as getAudioMeter, d as drawDetection, a as getMediaRecorder, c as createVideoFile, b as createImageFile, e as animateCircleDraw, V as VIDEO_CAPTURE_SCORE_THRESHOLD, f as detectFace, I as IMAGE_CAPTURE_SCORE_THRESHOLD, E as EColors, h as getImagePath, l as loadFaceApiModels, i as releaseUserMedia, R as RECORD_BUTTON_TIP } from './index-be4d7daf.js';
import { r as readyToTranslate } from './readyToTranslate-2905b12f.js';
import './tslib.es6-4451ae6b.js';

const micIconSvg = 'data:image/svg+xml;base64,';
      ...
      if (this.isRecording || runOnce) {
        ...
        if (!runOnce) {
          if (detection) {
            ...
            this.runDeferredFaceApiModel(false);
          }
          else {
