...
import { S as SVG_ICONS, O as OTP_WIDGET_TITLE } from './constants-bd45614c.js';
...
const AegonOtpCustomWidget = class {
   ...
   */
  render() {
    return (h("div", { class: "otp-form-wrapper" }, h("form", { onSubmit: (e) => { e.preventDefault(), this.submitOtpHandler(); } }, h("div", { class: "otp__input-container" }, h("div", { class: "otp__input-intent" }, h("h4", { class: "otp__input-intent-title" }, h("img", { src: this.otpIcon }), this.otpWidgetTitle)), h("div", { class: "otp__input-content" }, h("span", { class: "otp__input-intent-subtitle" }, "Please enter the verification code we sent you on ", this.maskedMobileNo), h("aegon-otp-input", { "otp-length": this.OtpLength, "auto-focus-first": "true" }), this.errorMessage &&
      ...
      h("div", { class: "otp__timer" }, this.showResendOTP
        ...
        : h("aegon-timer", { "time-limit-in-seconds": this.time, "pre-text": "Code expires in " })))))));
  }
};
